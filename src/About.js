...
function About() {
  return (
    ...
    <div class="first">
        <div class="second">
     <h1>ABOUT US</h1>
     <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Consequatur impedit atque, tempora nobis eveniet quibusdam, est deleniti animi numquam, laborum veniam! Illum blanditiis, reiciendis ducimus exercitationem soluta sed laudantium magnam!</p>
</div>
    ...
    <div className='img-first'>
        <img src="./developer-team.png" alt=""/>
    </div>
        <div class="second">
...
<div class="row">
  ...
  <div class="col-lg-3 mb-4">
    ...
    <div class="row">
      ...
      <div class="col-md-12 text-center">
        <div class="pt-2">
          <h5 class="mt-4 font-weight-medium mb-0">Rahul</h5>
          <h6 class="subtitle mb-3">Property Specialist</h6>
          <p>You can relay on our amazing features list and also our customer services will be great experience.</p>
          <ul class="list-inline">
            <li class="list-inline-item"><a href="#" class="text-decoration-none d-block px-1"><i class="icon-social-facebook"></i></a></li>
  ...
  <div class="col-lg-3 mb-4">
    ...
    <div class="row">
      ...
      <div class="col-md-12 text-center">
        <div class="pt-2">
          <h5 class="mt-4 font-weight-medium mb-0">chaitanya</h5>
          <h6 class="subtitle mb-3">Property Specialist</h6>
          <p>You can relay on our amazing features list and also our customer services will be great experience.</p>
          <ul class="list-inline">
            <li class="list-inline-item"><a href="#" class="text-decoration-none d-block px-1"><i class="icon-social-facebook"></i></a></li>
  ...
  <div class="col-lg-3 mb-4">
    ...
    <div class="row">
      ...
      <div class="col-md-12 text-center">
        <div class="pt-2">
          <h5 class="mt-4 font-weight-medium mb-0">Narendra</h5>
          <h6 class="subtitle mb-3">Property Specialist</h6>
          <p>You can relay on our amazing features list and also our customer services will be great experience.</p>
          <ul class="list-inline">
            <li class="list-inline-item"><a href="#" class="text-decoration-none d-block px-1"><i class="icon-social-facebook"></i></a></li>
